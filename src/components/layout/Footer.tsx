...
export default function Footer() {
  return (
    <footer className="w-full px-8 pb-20 pt-10 md:py-10 flex flex-col items-center text-center bg-white border-t-4 border-primary-container relative overflow-hidden">
